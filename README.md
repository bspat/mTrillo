# Podręcznik do systemu mTrillo

W tym miejscu można znaleźć podręcznik do systemu stenotypii polskiej mTrillo, jak również tłumaczenie na język polski oryginalnego podręcznika Zachodniosłowiańskiej Stenografii Maszynowej P. Trillo.

## Czym jest mTrillo

mTrillo --- ***m** *odyfikowany system P.* ***Trillo*** --- jest to system stenotypii dla języka polskiego, w znacznej mierze oparty na systemie autorstwa p. P. Trillo z 2023 roku. Główne różnice w stosunku do pierwowzoru:
* uregularyzowanie i uproszczenie zasad
* zmiany w niektórych grupach spółgłoskowych celem zmniejszenia ilości konfliktów
...
Jest to nowy podręcznik poświęcony systemowi mTrillo. Od powyższych podręczników różni się ww. zmianami w systemie, jak również organizacją materiału oraz budową ćwiczeń.
